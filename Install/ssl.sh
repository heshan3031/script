...
(echo mx; echo @ALEX_MX; echo VENTA DE VPS DE PAGA; echo WHATSAPP +526672374392; echo TELEGRAM @ALEX-MX; echo @ALEX_MX; echo @ALEX_MX)|openssl req -new -x509 -key key.pem -out cert.pem -days 1000 > /dev/null 2>&1
