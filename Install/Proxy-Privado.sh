...
read -p "Opcion: " cor
case $cor in
"1")corx="</font><font color="red">${mensage}";;
"2")corx="</font><font color="green">${mensage}";;
"3")corx="</font><font color="purple">${mensage}";;
"4")corx="</font><font color="orange">${mensage}";;
"5")corx="<span style='color: #18ffd9;'>${mensage}</span>";;
"6")corx="</font><font color="yellow">${mensage}";;
"7")corx="</font><font color="blue">${mensage}";;
"8")corx="</font><font color="black">${mensage}";;
