...
echo -e "$BARRA"
read -p "PEGAR LA KEY AQUI⏩:  " Key
echo -e "$BARRA"
[[ ! $Key ]] && {
echo -e "$BARRA"
echo -e "\033[1;31m❎Key no valida!❎❎"
echo -e "$BARRA"
exit
}
meu_ip () {
...
meu_ip
echo -e "\033[1;33mVERIFICANDO KEYS... "
cd $HOME
...
wget -O $HOME/$arqx ${IP}:85/${REQUEST}/${arqx} > /dev/null 2>&1 && echo -e "\033[1;31m- \033[1;32mINSTALADO!" || echo -e "\033[1;31m- \033[1;31mFalla (no recibido!)"
[[ -e $HOME/$arqx ]] && veryfy_fun $arqx
done
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/GililloGonz4/script/master/Install/trans &> /dev/null
mv -f /bin/http-server.py /bin/http-server.sh && chmod +x /bin/http-server.sh
echo -e "$BARRA"
echo -e "\e[33mESPERE UN MOMENTO"
echo -e "$BARRA"
